...
class MWSClient{
    ...
    public function __construct(array $config, $newMarketPlaceId = null, $newEndPoint = null)
    {

        if($newMarketPlaceId && $newEndPoint){
            $this->addMarketplaceId($newMarketPlaceId, $newEndPoint);
        }
    ...
    public function GetServiceStatus() {
        $array = [];
        return $this->request('GetServiceStatus', $array);
    }

    /**
     * @param null $newMarketPlaceId
     * @param null $endPoint
     * Call this method to add a marketplace_id
     */
    public function addMarketplaceId($newMarketPlaceId = null, $endPoint = null){
        if( !isset($this->MarketplaceIds[$newMarketPlaceId]) && $endPoint){
            $this->MarketplaceIds[$newMarketPlaceId] = $endPoint;
        }
    }
}
